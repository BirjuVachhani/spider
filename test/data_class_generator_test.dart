...
void main() {
  ...
  group('process tests', () {
    ...
    test('asset generation test #1', () async {
      ...
      final SpiderConfiguration config = retrieveConfigs()!;
      expect(
        config,
        isNotNull,
      ...
      DartClassGenerator(config.groups.first, config.globals).process();
