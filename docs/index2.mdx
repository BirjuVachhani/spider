---
title: Spider
description: A small dart CLI tool to generate Assets dart code from assets folder.
...
1
<Image src="https://cdn.buymeacoffee.com/buttons/default-blue.png" height="51" width="217" style={{ alignSelf: 'left' }}/>
